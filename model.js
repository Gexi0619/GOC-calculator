    ...
    !function(t, n) {
        ...
        C.extend({
            ...
            makeArray: function(e, t) {
                var n = t || [];
                return null != e && (S(Object(e)) ? C.merge(n, "string" == typeof e ? [e] : e) : l.call(n, e)),
                n
            },
                ...
                var t = [["notify", "progress", C.Callbacks("memory"), C.Callbacks("memory"), 2], ["resolve", "done", C.Callbacks("once memory"), C.Callbacks("once memory"), 0, "resolved"], ["reject", "fail", C.Callbacks("once memory"), C.Callbacks("once memory"), 1, "rejected"]]
                  ...
                  , o = {
                    ...
                    then: function(e, r, o) {
                                ...
                                var s = this
                                  ...
                                  , l = function() {
                                    ...
                                    if (!(e < i)) {
                                        ...
                                        y(l) ? o ? l.call(n, a(i, t, I, o), a(i, t, _, o)) : (i++,
                                        l.call(n, a(i, t, I, o), a(i, t, _, o), a(i, t, I, t.notifyWith))) : (r !== I && (s = void 0,
                                        u = [n]),
                                        (o || t.resolveWith)(s, u))
                                    }
                                }
                        ...
                        return C.Deferred((function(n) {
                            t[0][3].add(a(0, n, y(o) ? o : I, n.notifyWith)),
        ...
        C.event = {
            ...
            special: {
                ...
                click: {
                    setup: function(e) {
                        var t = this || e;
                        return ge.test(t.type) && t.click && N(t, "input") && je(t, "click", Se),
                        !1
                    },
                    trigger: function(e) {
                        var t = this || e;
                        return ge.test(t.type) && t.click && N(t, "input") && je(t, "click"),
                        !0
                    },
                    _default: function(e) {
                        var t = e.target;
        ...
        function $e(e, t, n) {
            ...
            !v.pixelBoxStyles() && _e.test(a) && Be.test(t) && (r = s.width,
            o = s.minWidth,
            i = s.maxWidth,
        ...
        C.extend(C.event, {
            trigger: function(e, t, r, o) {
                ...
                o || !f.trigger || !1 !== f.trigger.apply(r, t))) {
                    ...
                    return e.type = g,
                    o || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !Y(r) || l && y(r[g]) && !m(r) && ((s = r[l]) && (r[l] = null),
                    C.event.triggered = g,
        ...
        C.extend({
            ...
            ajax: function(e, t) {
                ...
                e = void 0),
                t = t || {};
                var r, o, i, a, s, u, l, c, f, p, d = C.ajaxSetup({}, t), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? C(h) : C.event, v = C.Deferred(), y = C.Callbacks("once memory"), m = d.statusCode || {}, b = {}, w = {}, T = "canceled", S = {
                    readyState: 0,
                ...
                null == d.crossDomain) {
                    ...
                    try {
                        u.href = d.url,
                        u.href = u.href,
                        d.crossDomain = _t.protocol + "//" + _t.host != u.protocol + "//" + u.host
                    } catch (e) {
                        d.crossDomain = !0
                    }
                }
                ...
                d.data && (d.processData || "string" == typeof d.data) && (o += (St.test(o) ? "&" : "?") + d.data,
                delete d.data),
                !1 === d.cache && (o = o.replace(Lt, "$1"),
                p = (St.test(o) ? "&" : "?") + "_=" + Ct.guid++ + p),
                d.url = o + p),
                d.ifModified && (C.lastModified[o] && S.setRequestHeader("If-Modified-Since", C.lastModified[o]),
                ...
                S.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + It + "; q=0.01" : "") : d.accepts["*"]),
                d.headers)
                ...
                function E(e, t, a, u) {
                    ...
                    f ? (d.ifModified && ((w = S.getResponseHeader("Last-Modified")) && (C.lastModified[o] = w),
        ...
        C.ajaxPrefilter("json jsonp", (function(e, t, r) {
            ...
            if (s || "jsonp" === e.dataTypes[0])
                ...
                s ? e[s] = e[s].replace(Vt, "$1" + o) : !1 !== e.jsonp && (e.url += (St.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
...
, function(e, t, n) {
    ...
    function i(e) {
        ...
        2 == t.length ? e && o()("div[data-calc-id=" + t[1] + "]").trigger("click") : o()(".js-back-btn").trigger("click")
    }
    window.$ = window.jQuery = o.a,
    o()(document).ready((function() {
        o()(".js-btn").click((function(e) {
            window.scrollTo(0, 0);
            var t = o()(e.target).data("calc-id");
            history.pushState({}, "", "#" + t),
            o()(".cs-toolbox__calc").hide(),
            o()("#" + t).show(),
            o()(".cs-toolbox__menu").removeClass("cs-toolbox__menu--active"),
            o()(".cs-toolbox__calc-wrapper").removeClass("hidden")
        }
        )),
        o()(".js-back-btn").click((function() {
            window.scrollTo(0, 0),
            history.pushState({}, "", window.location.href.split("#")[0]),
            o()(".cs-toolbox__menu").addClass("cs-toolbox__menu--active"),
            o()(".cs-toolbox__calc-wrapper").addClass("hidden")
        }
        )),
        i(!0)
    }
